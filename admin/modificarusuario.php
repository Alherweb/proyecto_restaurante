                                        ...
                                        <?php 
                                            ...
                                            while($row=mysql_fetch_array($resultado)){
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td><input type="text" class="password" value="'.$row[4].'"></td>
                                                            <td><button class="eliminarusuario" data-id="'.$row[0].'">Eliminar</button></td>
                                                            <td><button class="modificarusuario" data-id="'.$row[0].'">Modificar</button></td>
                                                    </tr>
                                                    ';
                                            }
                                        ?>
